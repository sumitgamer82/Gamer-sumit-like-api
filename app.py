        ...
        <header class="sticky top-0 z-50 bg-black/50 backdrop-blur-md border-b border-yellow-400/10">
            <div class="max-w-7xl mx-auto px-4 h-14 flex items-center justify-between">
                <div class="flex items-center gap-2">
                    <div class="w-8 h-8 bg-gradient-to-br from-red-950 via-red-600 to-red-950 rounded-lg flex items-center justify-center font-black text-yellow-400 text-sm border border-yellow-400/30 shadow-lg shadow-red-600/20">KA</div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-3">
                    ...
                    <div class="glass-premium p-5 rounded-3xl border-white/5">
                        <div class="flex items-start gap-4">
                            <div class="w-12 h-12 bg-gradient-to-br from-red-950 via-red-600 to-red-950 rounded-xl flex items-center justify-center text-yellow-400 border border-yellow-400/20">KA</div>
                            <div>
                ...
                <div class="flex flex-col md:flex-row justify-between items-center gap-8">
                    <div class="text-center md:text-left space-y-4">
                        <div class="flex items-center justify-center md:justify-start gap-3">
                            <div class="w-10 h-10 bg-gradient-to-br from-red-950 via-red-600 to-red-950 rounded-xl flex items-center justify-center font-black text-yellow-400 border border-yellow-400/30">KA</div>
